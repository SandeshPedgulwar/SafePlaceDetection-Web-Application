...
String id=request.getParameter("id");
  try
  {
  		...
  		PreparedStatement ps=con.prepareStatement("Select * from spot_info where location_name=?");
  		ps.setString(1, id);
    ...
    <div class="container-scroller">
      ...
      <nav class="sidebar sidebar-offcanvas" id="sidebar">
        ...
        <ul class="nav">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="add_informer.html">
              <span class="menu-icon">
                <i class="mdi mdi-account-plus"></i>
              </span>
              <span class="menu-title">Add Informer</span>
            </a>
          </li>
          <li class="nav-item menu-items">
            <a class="nav-link" href="view_informer_info.jsp">
              <span class="menu-icon">
                <i class="mdi mdi-account"></i>
              </span>
              <span class="menu-title">View Informer</span>
            </a>
          </li>
          <li class="nav-item menu-items">
            <a class="nav-link" href="admin_add_spot.html">
              <span class="menu-icon">
          ...
          <li class="nav-item menu-items">
            <a class="nav-link" href="admin_view_spot.jsp">
              <span class="menu-icon">
                <i class="mdi mdi-eye"></i>
              </span>
              <span class="menu-title">View All Spots</span>
            </a>
          </li>
          <li class="nav-item menu-items">
            <a class="nav-link" href="view_user_info.jsp">
              <span class="menu-icon">
                <i class="mdi mdi-account"></i>
              </span>
          ...
          <div class="content-wrapper">
            <div class="page-header">
              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    <h4 class="card-title">Update Spot</h4>
                    <p class="card-description"> Spot details: </p>
                    <form action="Update_spot_info" method="post" class="forms-sample">
...
function showPosition(position) {
	...
	document.getElementById("longitude_text").value = position.coords.longitude;
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input style="color: black;" value="<%=rs.getString("latitude")%>" type="text" id="latitude_text" name="latitude" class="form-control" id="exampleInputMobile" placeholder="Latitude">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="exampleInputMobile" class="col-sm-3 col-form-label">Longitude</label>
                        <div class="col-sm-9">
                          <input style="color: black;" value="<%=rs.getString("longitude")%>" type="text" id="longitude_text" name="longitude" class="form-control" id="exampleInputMobile" placeholder="Longitude">
                        </div>
                      </div>
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="informer_id" class="form-control" id="" placeholder="Informer ID" value="<%=rs.getString("informer_id")%>">
                        </div>
                      	</div>
                      	<div class="form-group row">
                        <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Location Name</label>
                        <div class="col-sm-9">
                          <input type="text" name="loc_name" value="<%=rs.getString("location_name")%>" class="form-control" id="exampleInputUsername2" placeholder="Location Name">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="exampleInputUsername2" class="col-sm-3 col-form-label">Exact Location Description</label>
                        <div class="col-sm-9">
                          <input type="text" name="loc_des" value="<%=rs.getString("location_description")%>" class="form-control" id="exampleInputUsername2" placeholder="Exact Location Description">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="exampleInputEmail2" class="col-sm-3 col-form-label">Address</label>
                        <div class="col-sm-9">
                          <input type="text" name="loc_address" value="<%=rs.getString("address")%>" class="form-control" id="exampleInputEmail2" placeholder="Address">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="exampleInputEmail2" class="col-sm-3 col-form-label">City</label>
                        <div class="col-sm-9">
                          <input type="text" name="city"  value="<%=rs.getString("city")%>" class="form-control" id="exampleInputEmail2" placeholder="City">
                        </div>
                      </div>
                      ...
                      <select name="reason" class="form-control form-control-lg" id="exampleFormControlSelect1">
                        <option><%=rs.getString("reason")%></option>
                        <option>Crime</option>
                     ...
                     <div class="form-group row">
                      ...
                      <select name="zone_level" class="form-control form-control-lg" id="exampleFormControlSelect1">
                        <option><%=rs.getString("zone")%></option>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="precaution" value="<%=rs.getString("precaution")%>"class="form-control" id="exampleInputConfirmPassword2" placeholder="Precaution">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="exampleInputConfirmPassword2" class="col-sm-3 col-form-label">Nearby Hotels for Stay</label>
                        <div class="col-sm-9">
                          <input type="text" name="hotels" value="<%=rs.getString("hotels")%>" class="form-control" id="exampleInputConfirmPassword2" placeholder="Hotel 1, Hotel 2...">
                        </div>
                      </div>
                      <div class="form-group row">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="route1_sd" value="<%=rs.getString("route1_sd")%>" class="" id="exampleInputEmail2" placeholder="Initial Destination">
                          <input type="text" name="route1_fd" value="<%=rs.getString("route1_fd")%>" class="" id="exampleInputEmail2" placeholder="Final Destination">
                        </div>
                      </div>
