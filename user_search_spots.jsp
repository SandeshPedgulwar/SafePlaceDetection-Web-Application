              ...
              <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form action="search_spot_results.jsp" class="forms-sample">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-9">
                          <input type="text" name="spot_name" class="form-control" id="exampleInputUsername2" placeholder="Enter Location Name">
                        </div>
                      </div>
