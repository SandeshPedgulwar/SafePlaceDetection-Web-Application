...
<html lang="en">
 ...
 <%
  try
  {
  		...
  		PreparedStatement ps=con.prepareStatement("Select * from spot_info where informer_id=?");
  		ps.setString(1, id);
  ...
  %>
                          <tr>
                            ...
                            <td><%=rs.getString("location_description")%></td>
                       		...
                       		<td><a href="informer_update_spot.jsp?id=<%=rs.getString("location_name")%>">Update</a>&nbsp;&nbsp;/&nbsp;&nbsp;<a href="spot_delete.jsp?id=<%=rs.getString("location_name")%>">Delete</a></td>
